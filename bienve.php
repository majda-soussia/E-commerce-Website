...
if ($_SESSION['role'] === 'admin') {
    echo '<a href="admine.php">Admin </a>';
}
    ...
    <main class="account-dashboard">
        <div class="sidebar">
            ...
            <nav class="account-menu">
                ...
                <?php if ($role === 'admin'): ?>
                    <div class="menu-section">
                        <a href="admine.php" class="menu-item">
                            <img src="imges/compte.png" alt="Admin Info" class="menu-icon">
        ...
        <div class="welcom">
            ...
            <p>Use the menu on the left to manage users, view orders, or update your profile settings.</p>
            <p>For your security, remember to sign out when you're done.</p>
