...
<head>
    ...
    <title>Conditions Générales - CHIQUE.COM.TN</title>
    <style>
        :root {
    ...
    <aside>
        <div class="container">
            ...
            <div class="section">
                ...
                <p>By using the website www.chique.com.tn, you unreservedly accept these general terms and conditions.
                </p>
            </div>
            ...
            <div class="section">
                ...
                <ul>
                    <li>Site content is protected by copyright</li>
                    <li>Registered trademarks: CHIQUE® and associated logo</li>
            ...
            <div class="section">
                ...
                <ul>
                    ...
                    <li>Comply with security measures</li>
                </ul>
            </div>

            <div class="warning">
                <h3>Product Information</h3>
                <p>Product features may change without prior notice. Photos are non-contractual.</p>
            </div>
            ...
            <div class="section">
                ...
                <ul>
                    ...
                    <li>Refunds within 30 business days</li>
                </ul>
            </div>

            <div class="section">
                <h2>Liability</h2>
                <p>CHIQUE declines any responsibility for:</p>
                <ul>
                    <li>Unpredictable technical interruptions</li>
                    <li>Fraudulent use of login credentials</li>
            ...
            <div class="section">
                ...
                <p>CHIQUE reserves the right to modify these terms at any time. The applicable version is the one
                    available online at the time of order.</p>
            </div>

            <div class="warning">
                <h3>Jurisdiction</h3>
                <p>Any dispute shall be submitted to Tunisian courts. The applicable law is Tunisian law.</p>
            </div>

            <div class="contact-info">
                <h2>Contact</h2>
                <p><strong>CHIQUE Customer Service</strong><br>
                    📧 <a href="#">service.client@chique.com.tn</a><br>
                    📞 +216 53 640 191<br>
                    Opening hours: Monday–Friday 8:00 AM – 6:00 PM</p>
            </div>
        </div>
    </aside>
