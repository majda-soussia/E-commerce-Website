    ...
    <aside>
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="warning">
                    ⚠️ Please do not share your card details via email, fax, or on social media.
                </div>
            </div>
            ...
            <div class="section">
                <h2>User Rights</h2>
                <p>You may exercise your rights (access, correction, deletion) through:</p>
                <ul>
                    <li>📧 <a href="mailto:service.client@CHIQUE.com.tn">service.client@CHIQUE.com.tn</a></li>
                    <li>✉️ CHIQUE, Rocade Bourguiba - 3062 Sfax</li>
                </ul>
            </div>

            <div class="warning">
                <h3>Minors</h3>
                <p>Our website is not intended for minors. We do not knowingly collect data from individuals under the
                    age of 18.</p>
            </div>
        </div>
    </aside>
