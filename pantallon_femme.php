...
<head>
    ...
    <link rel="stylesheet" href="C:\Users\oumayma\OneDrive\Bureau\html\pontalon-femme.css">
...
<body>
    ...
    <main class="main-content">
        <h2 class="page-title">Women's pants</h2>

        <div class="product-grid" data-category="pantallonfemme">
            <!-- Product 1 -->
            <article class="product-card">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf11.png" alt="Pantalon évasé à plis jacquard élégant vintage"
                        class="product-image">
                    <h3 class="product-title">Pantalon évasé à plis jacquard élégant vintage</h3>
            ...
            <!-- Product 2 -->
            <article class="product-card" data-category="pantallonfemme">
                <a href="achete.html" class="product-link">
                    <img src="imges\pantallon_femme\pf21.png" alt="Pantalon coupe droite avec ceinture"
                        class="product-image">
                    <h3 class="product-title">Pantalon coupe droite avec ceinture</h3>
                    <div class="product-price">
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf31.png" alt="Jean large de couleur unie" class="product-image">
                    <h3 class="product-title">Jean large de couleur unie</h3>
                    <div class="product-price">
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf41.png" alt="Pantalon décontracté uni avec poches "
                        class="product-image">
                    <h3 class="product-title">Pantalon décontracté uni avec poches</h3>
                    <div class="product-price">
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf51.png " alt="set" class="product-image">
                    <h3 class="product-title">Pantalon large avec fente sur la cuisse </h3>
                    <div class="product-price">
                        <span class="old-price">$70.35</span>
                        <span class="current-price">$50.15</span>
                    </div>
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf61.png" alt="set " class="product-image">
                    <h3 class="product-title">Pantalon ample et droit avec fermeture éclair, cordon de serrage à la taille et motif à rayures
                    </h3>
                    <div class="product-price">
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf71.png" alt="set " class="product-image">
                    <h3 class="product-title">Jean d'été coupe droite taille papier </h3>
                    <div class="product-price">
                        <span class="old-price">$80.35</span>
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf81.png" alt="set " class="product-image">
                    <h3 class="product-title">Jean droit décontracté avec poches avant et boutons</h3>
                    <div class="product-price">
                        <span class="old-price">$90.35</span>
                        <span class="current-price">$60.15</span>
                    </div>
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf91.png" alt="set " class="product-image">
                    <h3 class="product-title">Pantalon large avec ceinture fixe </h3>
                    <div class="product-price">
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf101.png" alt="set " class="product-image">
                    <h3 class="product-title">Jean décontracté coupe ample à bas droit avec poches</h3>
                    <div class="product-price">
                        <span class="old-price">$40.35</span>
                        <span class="current-price">$30.15</span>
                    </div>
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf111.png" alt="set " class="product-image">
                    <h3 class="product-title">Pantalon à poches inclinées avec taille élastique et cordon de serrage</h3>
                    <div class="product-price">
                        <span class="old-price">$70.35</span>
            ...
            <article class="product-card" data-category="pantallonfemme">
                <a href="#" class="product-link">
                    <img src="imges\pantallon_femme\pf121.png" alt="set " class="product-image">
                    <h3 class="product-title">Jean décontracté coupe ample à bas droit avec poches </h3>
                    <div class="product-price">
                        <span class="old-price">$90.35</span>
    ...
    <footer class="footer">
        <div class="footer-container">
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    <li><a href="C:\Users\oumayma\OneDrive\Bureau\html\moncompte.html" class="footer-link">Connexion</a>
                    </li>
                    <li><a href="C:\Users\oumayma\OneDrive\Bureau\html\creercompte.html" class="footer-link">Créer un
                            compte</a></li>
            ...
            <div class="footer-section">
                ...
                <div class="social-links">
                    ...
                    <a href="#" class="social-link" aria-label="Snapchat">
                        <img src="imges\fb.png" alt="Snapchat" width="24" height="24">
                    </a>
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-container">
                <p class="copyright">&copy; 2025 My Shop. Tous droits réservés.</p>
                <ul class="legal-links">
                    <li><a href="C:\Users\oumayma\OneDrive\Bureau\html\confidentalite.html">Confidentialité</a></li>
                    <li><a href="C:\Users\oumayma\OneDrive\Bureau\html\condition.html">Conditions</a></li>
