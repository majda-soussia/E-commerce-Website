...
<body>
    ...
    <body>
                ...
                <ul class="nav-list">
                    <li class="nav-item has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="jupefemme1.html" class="submenu-link">Skirts</a></li>
        ...
        <div class="container">
            ...
            <div class="section">
              <h2>Data Controller (Website Owner)</h2>
              <div class="contact-info">
                <p><strong>CHIQUE Stores Company (CHIQUE)</strong><br>
                Rocade Bourguiba, between Gremda Road and Caied M’Hamed Road<br>
                3032 Sfax – Tunisia<br>
                📧 <a href="mailto:service.client@CHIQUE.com.tn">service.client@CHIQUE.com.tn</a><br>
                📞 +216 53 640 191<br>
                Registration Number: 0847329D</p>
              </div>
              <div class="warning">
                ⚠️ Please do not send credit card details via email, fax or social media.
              </div>
            </div>
            ...
            <div class="section">
              ...
              <ul>
                ...
                <li>Date of birth</li>
                <li>Gender</li>
                <li>Payment information (secure)</li>
              </ul>
            </div>
            ...
            <div class="section">
              ...
              <ul>
                ...
                <li>Certified payment systems</li>
                <li>Financial verification services</li>
              </ul>
            </div>
      
            <div class="section">
              <h2>User Rights</h2>
              <p>You can exercise your rights (access, correction, deletion) by contacting us:</p>
              <ul>
                <li>📧 <a href="mailto:service.client@CHIQUE.com.tn">service.client@CHIQUE.com.tn</a></li>
                <li>✉️ CHIQUE, Rocade Bourguiba – 3062 Sfax, Tunisia</li>
              </ul>
            </div>
      
            <div class="warning">
              <h3>Minors</h3>
              <p>This website is not intended for minors. We do not knowingly collect data from individuals under 18 years old.</p>
            </div>
          </div>
        </aside>
