...
<header class="header">
    ...
    <aside class="contact-container">
        ...
        <p>Have a question or need help with your order? Our team is here for you.</p>
        <p>Send us an email at: <a href="mailto:myshop@fashionvibe.com">support@fashionvibe.com</a></p>
        <p>We aim to reply within 24 hours (Monday–Friday).</p>
