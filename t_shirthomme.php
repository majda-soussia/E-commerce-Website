...
<head>
    ...
    <link rel="stylesheet" href="TSHIRT-HOMME.css">
    <title>Men's T-Shirt Collection | NameWebPage</title>
</head>
<style>
  :root {
...
<body>
        ...
        <nav class="nav">
            <ul class="nav-list">
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="t_shirtfemme.html" class="submenu-link">T-shirts</a></li>
                        <li><a href="#" class="submenu-link">Pants</a></li>
                        <li><a href="#" class="submenu-link">Dresses</a></li>
                        <li><a href="C:\Users\User\Desktop\projet web\jupefemme1.html" class="submenu-link">Skirts</a></li>
                ...
                <li class="nav-item search-item">
                    <form role="search" class="search-form">
                        ...
                        <button type="submit" aria-label="Search">
                            <img src="recher.png" alt="" width="25" height="15">
                        </button>
                    </form>
                </li>
                ...
                <li class="nav-item icon-item">
                    <a href="#" class="nav-icon" aria-label="Wishlist">
                        <img src="heart.png" alt="Wishlist" width="25" height="15">
                    </a>
                </li>
               
                <li class="nav-item icon-item">
                    <a href="#" class="nav-icon" aria-label="Shopping cart">
                        <img src="panier.png" alt="Cart" width="25" height="15">
                ...
                <li class="nav-item icon-item">
                    <a href="C:\Users\User\Desktop\projet web\mycompte.html" class="nav-icon" aria-label="My account">
                        <img src="compte.png" alt="Account" width="25" height="15">
                    </a>
                </li>
            </ul>
        </nav>
    ...
    <main class="main-content">
        <h2 class="page-title">Men's T-Shirts</h2>
       
        <div class="product-grid">
            <!-- Product 1 -->
            <article class="product-card">
                <a href="new-buy-product.html?id=1" class="product-link">
                    <img src="image1.png" alt="Homme T-shirt unicolore à col montant" class="product-image">
                    <h3 >Homme T-shirt unicolore à col montant</h3>
            ...
            <!-- Product 2 -->
            <article class="product-card">
                <a href="new-buy-product.html?id=2" class="product-link">
                    <img src="image2.png" alt="T-shirt homme classique à motif lettre BOSS" class="product-image">
                    <h3 >T-shirt homme classique à motif lettre BOSS</h3>
            ...
            <!-- Product 3 -->
            <article class="product-card">
                <a href="new-buy-product.html?id=3" class="product-link">
                    <img src="image3.png" alt="Manfinity LEGND T-shirt à col rond " class="product-image">
                    <h3 >Manfinity LEGND T-shirt à col rond </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=4" class="product-link">
                    <img src="image4.png" alt="T-shirt décontracté à manches courtes " class="product-image">
                    <h3>T-shirt décontracté à manches courtes</h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=5" class="product-link">
                    <img src="image5.png" alt="set " class="product-image">
                    <h3>T-shirt à manches courtes imprimé cœur</h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=7" class="product-link">
                    <img src="image6.png" alt="set " class="product-image">
                    <h3>Manfinity Homme T-shirt à col ras </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=8" class="product-link">
                    <img src="image7.png" alt="set " class="product-image">
                    <h3>Homme T-shirt à col ras  </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=8" class="product-link">
                    <img src="image8.png" alt="set " class="product-image">
                    <h3>Manfinity Homme T-shirt à col ras </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=9" class="product-link">
                    <img src="image9.png" alt="set " class="product-image">
                    <h3>Manfinity Homme T-shirt à col ras</h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=10" class="product-link">
                    <img src="image10.png" alt="set " class="product-image">
                    <h3>T-shirt à manches courtes ample</h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=11" class="product-link">
                    <img src="image11.png" alt="set " class="product-image">
                    <h3> Manifesty T-shirt à manches courtes ample </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=12" class="product-link">
                    <img src="image12.png" alt="set " class="product-image">
                    <h3> Manifesty T-shirt </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=13" class="product-link">
                    <img src="image13.png" alt="set " class="product-image">
                    <h3> T-shirt à manches courtes ample </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=14" class="product-link">
                    <img src="image14.png" alt="set " class="product-image">
                    <h3>T-shirt casual avec imprimé anglais </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=15" class="product-link">
                    <img src="image15.png" alt="set " class="product-image">
                    <h3> Manifesty T-shirt casual </h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
                    </div>
            ...
            <article class="product-card">
                <a href="new-buy-product.html?id=16" class="product-link">
                    <img src="image16.png" alt="set " class="product-image">
                    <h3> T-shirt casual avec imprimé anglais</h3>
                    <div class="product-price">
                        <span class="old-price">$60.35</span>
                        <span class="current-price">$90.15</span>
