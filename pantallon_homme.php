...
<head>
  ...
  <link rel="stylesheet" href="PANTS-HOMME.css">
...
<header class="header">
  ...
  <main class="main-content">
    <h2 class="page-title">Men's Pants</h2>

    <div class="product-grid">
      <!-- Product 1 -->
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=50" class="product-link">
          <img src="imges\pantallon_homme\pant1.png" alt="pant" class="product-image">
          <h3>Manfinity Hypermode Pantalon pour hommes avec bordure</h3>
          <div class="product-price">$50.99</div>
        </a>
        <button class="wishlist-button" aria-label="Add to wishlist" data-product-id="50">♥</button>
      </article>

      <!-- Product 2 -->
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=51" class="product-link">
          <img src="imges\pantallon_homme\pant2.png" alt="pant" class="product-image">
          <h3> Hypermode Pantalon pour hommes avec bordure</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$45.30</span>
          </div>
        </a>
        <button class="wishlist-button" aria-label="Add to wishlist" data-product-id="51">♥</button>
      </article>

      <!-- Product 3 -->
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=52" class="product-link">
          <img src="imges\pantallon_homme\pant3.png" alt="Manfinity LEGND T-shirt à col rond " class="product-image">
          <h3> Pantalon pour hommes avec bordure</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
          </div>
        </a>
        <button class="wishlist-button" aria-label="Add to wishlist" data-product-id="52">♥</button>
      </article>
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=53" class="product-link">
          <img src="imges\pantallon_homme\pant4.png" alt="T-shirt décontracté à manches courtes " class="product-image">
          <h3>ROMWE MEN Street Life Pantalon casual simple</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
          </div>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=54" class="product-link">
          <img src="imges\pantallon_homme\pant5.png" alt="set " class="product-image">
          <h3>Pantalon casual simple</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
          </div>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=6" class="product-link">
          <img src="imges\pantallon_homme\pant6.png" alt="set " class="product-image">
          <h3>Manfinity Hypermode Pantalon pour hommes avec bordure </h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=55" class="product-link">
          <img src="imges\pantallon_homme\pant7.png" alt="set " class="product-image">
          <h3>New Homme Pantalon </h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
          </div>
        </a>
        <button class="wishlist-button" aria-label="Add to wishlist" data-product-id="55">♥</button>
      </article>
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=56" class="product-link">
          <img src="imges\pantallon_homme\pant8.png" alt="set " class="product-image">
          <h3>Manfinity Hypermode Pantalon pour hommes avec bordure</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
        ...
        <button class="wishlist-button" aria-label="Add to wishlist" data-product-id="56">♥</button>
      </article>
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=57" class="product-link">
          <img src="imges\pantallon_homme\pant9.png" alt="set " class="product-image">
          <h3>Hypermode Pantalon pour hommes avec bordure</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
        ...
        <button class="wishlist-button" aria-label="Add to wishlist" data-product-id="57">♥</button>
      </article>
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=10" class="product-link">
          <img src="imges\pantallon_homme\pant10.png" alt="set " class="product-image">
          <h3>Modern Pantalon For Men</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
          </div>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=54" class="product-link">
          <img src="imges\pantallon_homme\pant11.png" alt="set " class="product-image">
          <h3>Manfinity Hypermode Pantalon pour hommes avec bordure</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=12" class="product-link">
          <img src="imges\pantallon_homme\pant12.png" alt="set " class="product-image">
          <h3> Casual Pantalon Whith Basic Color </h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
          </div>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=13" class="product-link">
          <img src="imges\pantallon_homme\pant13.png" alt="set " class="product-image">
          <h3>Manfinity Hypermode Pantalon pour hommes avec bordure</h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=14" class="product-link">
          <img src="imges\pantallon_homme\pant14.png" alt="set " class="product-image">
          <h3>SUMWON Pantalon coupe droite avec bande </h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
          </div>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=15" class="product-link">
          <img src="imges\pantallon_homme\pant15.png" alt="set " class="product-image">
          <h3> Manfinity Hypermode Pantalon pour hommes avec bordure </h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
      ...
      <article class="product-card" data-category="t_shirtfemme">
        <a href="new-buy-pants.html?id=16" class="product-link">
          <img src="imges\pantallon_homme\pant16.png" alt="set " class="product-image">
          <h3> Pantalon very casual </h3>
          <div class="product-price">
            <span class="old-price">$60.35</span>
            <span class="current-price">$90.15</span>
          </div>
