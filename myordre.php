...
try {
    ...
    // Récupération panier
    $stmt = $conn->prepare("
        SELECT p.produit_id, pr.nomp, p.quantite, pr.prix, p.taille 
        FROM panierr p
...
<head>
    ...
    <title>Welcome - SHOP.COM.TN</title>
    <style>
        :root {
            ...
            <ul class="nav-list">
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="pantallonfemme.php" class="submenu-link">Pants</a></li>
        ...
        <div>
            ...
            <?php if (!empty($articles)): ?>
                <?php foreach ($articles as $article): ?>
                    <div class="article">
                        <h3><?= htmlspecialchars($article['nomp']) ?></h3>
                        <p>Taille : <?= htmlspecialchars($article['taille']) ?></p>
